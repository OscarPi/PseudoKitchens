...
class Datasets:
    def __init__(
        ...
        if self.foundation_model == "dinov2":
            self.foundation_model_string = "dinov2_vitg14"
        elif self.foundation_model == "clip":
            self.foundation_model_string = "clip_ViT-L_14"
        else:
            self.foundation_model_string = None
        ...
        if self.foundation_model is not None:
            cache_file = Path(representation_cache_dir) / f"{self.foundation_model_string}.pt"
    ...
    def _get_foundation_model_dataset(self, x, y, c, additional_concepts=None, use_provided_concepts=True, no_concepts=False):
